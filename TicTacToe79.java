...
public class TicTacToe79
{
    ...
    public static boolean isxwinner (int [][]winxgrid)
    {
        boolean xiswinner = false;
        if (winxgrid[0][0] == 1 && winxgrid[0][1] == 1 && winxgrid [0][2] ==1)
        {
            xiswinner = true;
        }
        else if (winxgrid [1][0] == 1 && winxgrid [1][1] == 1 && winxgrid [1][2]== 1)
        {
            xiswinner = true;
        }
        else if (winxgrid [2][0] == 1 && winxgrid [2][1] == 1 && winxgrid [2][2] == 1)
        {
            xiswinner = true;
        }
        else if (winxgrid [0][0] == 1 && winxgrid [1][0] == 1 && winxgrid [2][0] == 1)
        {
            xiswinner = true;
        }
        else if (winxgrid [0][1] == 1 && winxgrid [1][1] == 1 && winxgrid [2][1] == 1)
        {
            xiswinner = true;
        }
        else if (winxgrid [0][2] == 1 && winxgrid [1][2] == 1 && winxgrid [2][2] == 1)
        {
            xiswinner = true;
        }
        else if (winxgrid [0][0] == 1 && winxgrid [1][1] == 1 && winxgrid [2][2] == 1)
        {
            xiswinner = true;
        }
        else if (winxgrid [2][0] == 1 && winxgrid [1][1] == 1 && winxgrid [0][2] == 1)
        {
            xiswinner = true;
        }
        return xiswinner;        
    ...
    public static boolean isowinner (int [][]winogrid)
    {
        boolean oiswinner = false;
        if (winogrid[0][0] == 2 && winogrid[0][1] == 2 && winogrid [0][2] == 2)
        {
            oiswinner = true;
        }
        else if (winogrid [1][0] == 2 && winogrid [1][1] == 2 && winogrid [1][2] == 2)
        {
            oiswinner = true;
        }
        else if (winogrid [2][0] == 2 && winogrid [2][1] == 2 && winogrid [2][2]  == 2)
        {
            oiswinner = true;
        }
        else if (winogrid [0][0] == 2 && winogrid [1][0] == 2 && winogrid [2][0] == 2)
        {
            oiswinner = true;
        }
        else if (winogrid [0][1] == 2 && winogrid [1][1] == 2 && winogrid [2][1] == 2)
        {
            oiswinner = true;
        }
        else if (winogrid [0][2] == 2 && winogrid [1][2] == 2 && winogrid [2][2]  == 2)
        {
            oiswinner = true;
        }
        else if (winogrid [0][0] == 2 && winogrid [1][1] == 2 && winogrid [2][2] == 2)
        {
            oiswinner = true;
        }
        else if (winogrid [2][0] == 2 && winogrid [1][1] == 2 && winogrid [0][2] == 2)
        {
            oiswinner = true;
        }
        return oiswinner;        
